...
func DefaultReadOS(ctx context.Context, in *OS, db *gorm.DB) (*OS, error) {
	...
	if db, err = gorm1.ApplyFieldSelection(ctx, db, nil, &OSORM{}); err != nil {
		return nil, err
	}
...
func DefaultListOS(ctx context.Context, db *gorm.DB) ([]*OS, error) {
	...
	db, err = gorm1.ApplyCollectionOperators(ctx, db, &OSORM{}, &OS{}, nil, nil, nil, nil)
	if err != nil {
		return nil, err
	}
...
func DefaultReadOSMatch(ctx context.Context, in *OSMatch, db *gorm.DB) (*OSMatch, error) {
	...
	if db, err = gorm1.ApplyFieldSelection(ctx, db, nil, &OSMatchORM{}); err != nil {
		return nil, err
	}
...
func DefaultListOSMatch(ctx context.Context, db *gorm.DB) ([]*OSMatch, error) {
	...
	db, err = gorm1.ApplyCollectionOperators(ctx, db, &OSMatchORM{}, &OSMatch{}, nil, nil, nil, nil)
	if err != nil {
		return nil, err
	}
...
func DefaultReadPortUsed(ctx context.Context, in *PortUsed, db *gorm.DB) (*PortUsed, error) {
	...
	if db, err = gorm1.ApplyFieldSelection(ctx, db, nil, &PortUsedORM{}); err != nil {
		return nil, err
	}
...
func DefaultListPortUsed(ctx context.Context, db *gorm.DB) ([]*PortUsed, error) {
	...
	db, err = gorm1.ApplyCollectionOperators(ctx, db, &PortUsedORM{}, &PortUsed{}, nil, nil, nil, nil)
	if err != nil {
		return nil, err
	}
...
func DefaultReadOSFingerprint(ctx context.Context, in *OSFingerprint, db *gorm.DB) (*OSFingerprint, error) {
	...
	if db, err = gorm1.ApplyFieldSelection(ctx, db, nil, &OSFingerprintORM{}); err != nil {
		return nil, err
	}
...
func DefaultListOSFingerprint(ctx context.Context, db *gorm.DB) ([]*OSFingerprint, error) {
	...
	db, err = gorm1.ApplyCollectionOperators(ctx, db, &OSFingerprintORM{}, &OSFingerprint{}, nil, nil, nil, nil)
	if err != nil {
		return nil, err
	}
...
func DefaultReadOSClass(ctx context.Context, in *OSClass, db *gorm.DB) (*OSClass, error) {
	...
	if db, err = gorm1.ApplyFieldSelection(ctx, db, nil, &OSClassORM{}); err != nil {
		return nil, err
	}
...
func DefaultListOSClass(ctx context.Context, db *gorm.DB) ([]*OSClass, error) {
	...
	db, err = gorm1.ApplyCollectionOperators(ctx, db, &OSClassORM{}, &OSClass{}, nil, nil, nil, nil)
	if err != nil {
		return nil, err
	}
